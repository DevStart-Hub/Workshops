---
title: "BTG 2024"
subtitle: "Bridging the Technological Gap Workshop"
execute:
  eval: false
...
In this tutorial, our primary tool will be Python!! There are lots of ways to install python. [We recommend installing it via Miniconda](https://tommasoghilardi.github.io/DevStart/CONTENT/GettingStarted/GettingStartedWithPython.html#miniconda). However, for this workshop, the suggested way to install Python is using [Anaconda](https://www.anaconda.com/download/success).
...
{{< downloadthis ../resources/Workshops/BTG2024/psychopy_GAP.yml label="Psychopy.yml" dname= "psychopy_GAP" type="outline-primary" >}}
...
![](../resources/Workshops/BTG2024//exampleTerminal_gap2024.png){fig-align="center" width="588"}
...
{{< downloadthis ../resources/Workshops/BTG2024/GAP_2024.zip label="Files" dname= "Files_Gap" icon="database-fill-down" type="outline-primary" >}}
...
![](../resources/Workshops/BTG2024/FinalFolder.png){fig-align="center" width="611"}
...
Below, you'll find a code example that adapts our [Create an eye-tracking experiment](https://tommasoghilardi.github.io/DevStart/CONTENT/EyeTracking/CreateAnEyetrackingExperiment.html) tutorial to work with a video file. The main differences are:
...
Here below we changed the example of [Calibrating eye-tracking](https://tommasoghilardi.github.io/DevStart/CONTENT/EyeTracking/EyetrackingCalibration.html) by increasing the focus_time to 2s. You can increase or decrease it based on your needs!!
