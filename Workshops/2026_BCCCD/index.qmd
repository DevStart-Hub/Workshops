...
<div class="badge-container">
  <span class="badge rounded-pill bg-light big-badge">
    ...
    <span class="small-text">BCCCD 2026 Conference</span>
  </span>
</div>
```
## About the Workshop

This workshop is part of the BCCCD 2026 conference pre-conference events and provides a hands-on introduction to Generalized Mixed-Effects Models (GLMMs) in R for developmental and comparative research.
